...
<body>
  <div class="container-fluid">
    ...
    <main>
      ...
      <div class="row">
        <article class="col-12 col-sm-12 col-md-7 col-lg-8 col-xl-8">
          ...
          <section class="secnews float-md-start float-lg-start float-xl-start">
            <img src="../projeto-integrador/images/sintoma1.png" alt="" class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4">
            <p class="pindex col-xl-4">Veja agora os principais sintomas do Covid-19, o que fazer quando
          ...
          <section class="secnews float-md-end float-lg-end float-xl-end">
        ...
        <section class="col-sm-12 col-md-12 col-lg-12">
          ...
          <p class="prisco">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
